...
**Status:** PR1–PR3 merged with four-job CI verified; PR4 non-interactive OAuth verified locally on development/minimum Node; PR4 OS CI and interactive OAuth pending
